...
- (BOOL) isLaterThanDateString:(NSString*)dateString{
    
    //NSString* openDate = @"20160407180701";
    ...
    [format setLocale:[[NSLocale alloc] initWithLocaleIdentifier:[[NSLocale currentLocale] localeIdentifier]]];
    NSLog(@"hasAMPM:%d",hasAMPM);
//    if (hasAMPM) {//12小时制
...
//    }
    ...
    NSDate* dest = [format dateFromString:dateString];
    return [[NSDate new] isLaterThanDate:dest];
